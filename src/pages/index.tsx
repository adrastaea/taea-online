              ...
              <div className="flex flex-col gap-4 xl:flex-row">
                ...
                >
                  <p className="">
                    ...
                    Mechanical Engineering in 2020 with a focus in Computer
                    Aided Design. In every role I&apos;ve ever had, I have found
                    a way to raise the level of everyone around me with the
                    software tools I build. I love learning new tech, and pride
                    myself on being the fullest of full stack engineers from
                    hardware, to web apps, databases, CI/CD, backend systems,
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        Python developers build web app front ends in Python,
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        playground. At Superpedestrian, we built our web apps
                        with React, and while it wasn&apos;t a focus of my team,
                        I would sometimes spend some time debugging it when I
                        came across a bug in order to write a good bug ticket.
                        My goal is to be as good with it as I am with Qt.
                      </p>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        ...
                        2024 to try to upskill between jobs. I knew a fair bit
                        of the concepts from my minor classes at OSU, and
                        keeping up with the industry, but the depth of the
                        material in this has been super interesting. I&apos;m
                        about 1/2 way through and hope to post a review soon.
                      </p>
                    </li>
                  </ul>
                </div>
